...
for epoch in range(num_epochs):
    ...
    if avg_vloss < best_vloss:
        ...
        model_path = f"unet3_model_{timestamp}_epoch{epoch}.pth"
...
plt.savefig(f"unet3_training_validation_loss_{timestamp}.png", dpi=300)
...
np.save(f"unet3_predictions_{timestamp}.npy", predictions)
np.save(f"unet3_targets_{timestamp}.npy",     targets)
