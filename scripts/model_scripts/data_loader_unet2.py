...
class CombinedDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        dynamic_resampled = np.stack([np.full([static_data.shape[1],static_data.shape[2]],dynamic_data[0]),
                                      np.full([static_data.shape[1],static_data.shape[2]],dynamic_data[1])])
