...
class UNetFusion(nn.Module):
    def __init__(self, in_channels=88, out_channels=1):
        """
        Simple UNet that expects 'in_channels' (currently default 88) total input channels.
        """
        super().__init__()
        ...
        # Create UpBlocks (reverse the channel progression)
