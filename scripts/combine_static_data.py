...
# Rename band_data from DEM to elevation
...
output_netcdf_dir = os.path.join(output_dir, "combined_static_data.nc")
static_ds.to_netcdf(output_netcdf_dir)

print(f"Combined dataset saved to: {output_netcdf_dir}")
